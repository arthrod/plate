...
### January 20 #28.4
- `block-discussion`: Updated badge counting to include discussion/suggestion replies (not only thread count).
- `export-toolbar-button`: Included suggestion-linked discussion replies in DOCX comment export.
