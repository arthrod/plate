...
export const uiComponents: Registry['items'] = [
  ...
  {
    dependencies: ['@platejs/pagination', 'sonner'],
    description: 'A pagination toolbar button.',
...
export const uiNodes: Registry['items'] = [
  ...
  },
  {
    ...
    registryDependencies: ['suggestion', 'suggestion-kit'],
  ...
  },
  {
    ...
    name: 'date-node',
    registryDependencies: ['@shadcn/calendar', 'suggestion'],
    title: 'Date Element',
    type: 'registry:ui',
  },
  {
    ...
    name: 'equation-node',
    registryDependencies: ['@shadcn/popover', 'suggestion'],
  ...
  },
  {
    ...
    name: 'mention-node',
    registryDependencies: ['suggestion', 'use-mounted', 'inline-combobox'],
    title: 'Mention Nodes',
    type: 'registry:ui',
  },
  {
