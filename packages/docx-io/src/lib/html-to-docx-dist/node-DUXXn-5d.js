...
*/
function buildTextElement$1(text) {
...
const buildTextElement = (text) => fragment({ namespaceAlias: {
	w: namespaces.w,
...
const buildTextRunFragment = (text, attributes, options) => {
	...
	runFragment.import(options?.deleted ? buildDeletedTextElement(text) : buildTextElement(text));
	runFragment.up();
	return runFragment;
};
/**
...
*/
const convertSVGtoPNGSharp = async (svgBase64, width, height) => {
	try {
		const sharpModule = await import("sharp");
		return (await (sharpModule.default || sharpModule)(Buffer.from(svgBase64, "base64"), { density: 72 }).resize(width, height, {
			fit: "contain",
			background: {
				r: 255,
				g: 255,
...
//#endregion
export { footerFileName as $, applicationName as A, commentsIdsType as B, generateHexId as C, wrapRunWithSuggestion as D, splitDocxTrackingTokens as E, commentsExtensibleContentType as F, defaultFontSize as G, defaultDirection as H, commentsExtensibleRelationshipType as I, defaultLang as J, defaultHTMLString as K, commentsExtensibleType as L, commentsExtendedContentType as M, commentsExtendedRelationshipType as N, namespaces as O, commentsExtendedType as P, documentFileName as Q, commentsIdsContentType as R, findDocxTrackingTokens as S, resetAllocatedIds as T, defaultDocumentOptions as U, commentsType as V, defaultFont as W, defaultTableBorderAttributeOptions as X, defaultOrientation as Y, defaultTableBorderOptions as Z, buildDeletedTextElement as _, themeType as _t, DOCX_DELETION_END_TOKEN_PREFIX as a, internalRelationship as at, buildTextElement$1 as b, DOCX_INSERTION_END_TOKEN_PREFIX as c, landscapeWidth as ct, allocatedIds as d, peopleRelationshipType as dt, footerType as et, buildCommentEndToken as f, peopleType as ft, buildCommentStartToken as g, themeFolder as gt, buildCommentReferenceRun as h, themeFileName as ht, DOCX_COMMENT_TOKEN_SUFFIX as i, imageType as it, colorlessColors as j, SVG_UNIT_TO_PIXEL_CONVERSIONS as k, DOCX_INSERTION_START_TOKEN_PREFIX as l, paragraphBordersObject as lt, buildCommentRangeStart as m, relsFolderName as mt, DOCX_COMMENT_END_TOKEN_PREFIX as n, headerType as nt, DOCX_DELETION_START_TOKEN_PREFIX as o, landscapeHeight as ot, buildCommentRangeEnd as p, portraitMargins as pt, defaultHeadingOptions as q, DOCX_COMMENT_START_TOKEN_PREFIX as r, hyperlinkType as rt, DOCX_DELETION_TOKEN_SUFFIX as s, landscapeMargins as st, generateContainer as t, headerFileName as tt, DOCX_INSERTION_TOKEN_SUFFIX as u, peopleContentType as ut, buildSuggestionEndToken as v, verticalAlignValues as vt, hasTrackingTokens as w, ensureTrackingState as x, buildSuggestionStartToken as y, wordFolder as yt, commentsIdsRelationshipType as z };

//# sourceMappingURL=node-DUXXn-5d.js.map