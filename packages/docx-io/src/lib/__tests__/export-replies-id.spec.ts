...
import type { CommentPayload } from "../html-to-docx-dist/browser";
import { splitDocxTrackingTokens } from "../html-to-docx-dist/browser";
...
describe("resolveCommentMeta with reply IDs", () => {
	it("should include IDs in replies", () => {
		...
		// Verify that the reply ID is preserved through the export process
