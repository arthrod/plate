...
const FIRST_PAGE_HEADER_KEY = "firstPageHeader";
const FIRST_PAGE_FOOTER_KEY = "firstPageFooter";
...
//#endregion
//#region src/lib/base-first-page-footer-plugin.ts
/**
...
*/
const BaseFirstPageFooterPlugin = createSlatePlugin({
	key: FIRST_PAGE_FOOTER_KEY,
	node: { isElement: true }
});

//#endregion
//#region src/lib/base-first-page-header-plugin.ts
/**
...
*/
const BaseFirstPageHeaderPlugin = createSlatePlugin({
...
const resolvePaginationOptions = (partial) => {
	const p = partial ?? {};
	return {
		firstPageDifferent: p.firstPageDifferent ?? PAGINATION_OPTION_DEFAULTS.firstPageDifferent,
...
const paginate = ({ ctx, doc, footnotePlacement = "footer", measurer, rect }) => {
	...
	for (const node of doc) {
		...
		if (node.type === HEADER_KEY || node.type === FOOTER_KEY || node.type === FIRST_PAGE_HEADER_KEY || node.type === FIRST_PAGE_FOOTER_KEY || footnotePlacement === "footer" && node.type === FOOTNOTE_DEFINITION_KEY) continue;
...
//#endregion
export { HEADER_KEY as A, BaseFirstPageHeaderPlugin as C, FIRST_PAGE_HEADER_KEY as D, FIRST_PAGE_FOOTER_KEY as E, FOOTER_KEY as O, BaseFooterPlugin as S, allocateFootnotes as T, getPaginationPages as _, replaceHeader as a, BasePageBreakPlugin as b, insertPageBreak as c, enforceHeaderFooterInvariants as d, PAGINATION_OPTION_DEFAULTS as f, getPaginationFootnotes as g, hasHeaderBlock as h, toggleFooter as i, PAGINATION_KEY as j, FOOTNOTE_DEFINITION_KEY as k, ensureHeader as l, hasFooterBlock as m, BasePaginationPlugin as n, replaceFooter as o, resolvePaginationOptions as p, toggleHeader as r, removeNodesByType as s, paginate as t, ensureFooter as u, getPageOfPath as v, BaseFirstPageFooterPlugin as w, BaseHeaderPlugin as x, setEditorPages as y };
//# sourceMappingURL=paginate-D-Fq-G4v.js.map